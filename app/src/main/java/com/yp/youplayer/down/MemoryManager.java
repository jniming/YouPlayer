...
public class MemoryManager {
    ...
    private static final int MAXMEMORY = 300 * 1024 * 1024;//程序运行的最大内存 (0-16m)
     ...
     * @return
     */
    public static boolean hasAvailableMemory() {
        // 获取手机内部空间大小
    ...
    public static long getAvailableInternalMemorySize() {
        ...
        long blockSize = stat.getBlockSize();// 返回 Int ，大小，以字节为单位
